...
import { 
  ...
  FaFileAlt, FaQuestionCircle, FaHome, 
  FaChevronDown, FaChevronRight, FaBars, FaSignOutAlt
} from 'react-icons/fa';
  ...
  return (
    <div style={styles.sidebar}>
      ...
      <ul style={styles.menuItems}>
        {/* Solo mostrar elementos según el rol */}
        {user?.role === 'ADMIN' && (
          <>
        ...
        {/* Elementos comunes para todos los roles administrativos */}
        <li style={styles.menuItem}>
